...
public class CoinStackBlocks {
	...
	static{
		...
		SMALL_NETHERITE_COIN_STACK = CoinStackBlocksFeatureLoader.registerSmallFireproofCoinStackBlock( CoinType.NETHERITE, "small_netherite_coin_stack", CoinStackBlocksFeature.NETHERITE_VALUE );
		...
		MEDIUM_NETHERITE_COIN_STACK = CoinStackBlocksFeatureLoader.registerMediumFireproofCoinStackBlock( CoinType.NETHERITE, "medium_netherite_coin_stack", CoinStackBlocksFeature.NETHERITE_VALUE * CoinStackBlocksFeature.MEDIUM_VALUE_MULTIPLIER );
		...
		LARGE_NETHERITE_COIN_STACK = CoinStackBlocksFeatureLoader.registerLargeFireproofCoinStackBlock( CoinType.NETHERITE, "large_netherite_coin_stack", CoinStackBlocksFeature.NETHERITE_VALUE * CoinStackBlocksFeature.LARGE_VALUE_MULTIPLIER );
		...
		NETHERITE_COIN_STACK_SLAB = CoinStackBlocksFeatureLoader.registerFireproofCoinStackSlabBlock( CoinType.NETHERITE, "netherite_coin_stack_slab", CoinStackBlocksFeature.NETHERITE_VALUE * CoinStackBlocksFeature.SLAB_VALUE_MULTIPLIER );
		...
		NETHERITE_COIN_STACK_BLOCK = CoinStackBlocksFeatureLoader.registerFireproofCoinStackBlock( CoinType.NETHERITE, "netherite_coin_stack_block", CoinStackBlocksFeature.NETHERITE_VALUE * CoinStackBlocksFeature.BLOCK_VALUE_MULTIPLIER );
	}
